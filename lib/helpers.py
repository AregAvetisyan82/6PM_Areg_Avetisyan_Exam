...
class Helpers:
    ...
    def select_from_dropdown_list(self, loc):
        self.actions.move_to_element(self.find(loc)).perform()
        self.actions.key_down(Keys.ARROW_DOWN).send_keys(Keys.ENTER).perform()
